        ...
        @if(auth()->check() && auth()->user()->isAdmin())
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="flex items-center gap-2 flex-wrap">
                            <span class="text-xs font-black uppercase tracking-wider text-white">Admin Live Mode</span>
                            <span class="text-[10px] bg-white/15 px-2 py-0.5 rounded font-mono text-gray-200">SKU: {{ $product->sku }}</span>
                        ...
                        <p class="text-[11px] text-gray-300 mt-0.5">
                            {{ $isArProd ? 'أنت تتصفح هذا المنتج كمسؤول في المتجر. يمكنك التعديل الفوري بالضغط على الزر:' : 'You are viewing this product live as Admin. You can edit this product directly:' }}
                        </p>
                    </div>
                </div>
            ...
            <div class="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
                ...
                >
                    ...
                    <span>{{ $isArProd ? 'تعديل المنتج' : 'Edit Product' }}</span>
                </a>
            </div>
        @endif
